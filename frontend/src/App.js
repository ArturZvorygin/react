...
function App() {
  ...
  return (
    <div className="App">
      ...
      <a href="*" ><img class="image1" height="500px" width="100%" src="https://southpointsouthbank.com.au/wp-content/uploads/2021/01/SP-BTM-Web-Directory-Retailer-Banner-McDonalds-scaled.jpg"></img></a>
      {pages[page]}
      {modalBoxes[modalBox]}
      <Footer />
